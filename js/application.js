...
tableau.extensions.initializeAsync().then(function () {
  ...
  */
            ...
            if(data[i][8].formattedValue == "BANKER"){
              Banker += data[i][10].value;
            }else if (data[i][8].formattedValue == "PLAYER"){
...
function GenerateHtmalTable(matchingRows){
     ...
     //  $('#my-table').DataTable().clear().destroy();
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            const BetType = row.insertCell(9);
            BetType.innerHTML = data[i].BetType;
